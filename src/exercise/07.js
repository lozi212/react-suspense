...
// Code splitting with different loading times
...
function App() {
  ...
  function handleSubmit(pokemonName) {
    startTransition(() => {
      setPokemonResource(
        createResource(fetchUser(pokemonName)),
      )
    })
  }
  ...
  return (
    <div className="pokemon-info-app">
      <div className={cn.root}>
        ...
        >
          {/* SuspenseList controls the order of loading */}
          <React.SuspenseList revealOrder="forwards">
            ...
            <div className={cn.mainContentArea}>
              {/* SuspenseList for the left navigation */}
              <React.SuspenseList revealOrder="forwards">
                <React.Suspense fallback={fallback}>
                  <LeftNav />
                </React.Suspense>

                {/* 💯 Extra Credit: Nested SuspenseList */}
